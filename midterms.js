...
function darkModeOn() {
  ...
  if (headerImage) {
    headerImage.style.backgroundImage = "url('./dark_mode.png')"; // Change to dark mode background
  }
}
...
function darkModeOff() {
  ...
  if (headerImage) {
    headerImage.style.backgroundImage = "url('./Untitled design (1).png')"; // Change to light mode background
  }
}
