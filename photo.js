...
function darkModeOn() {
  ...
  if (headerImage) {
    headerImage.style.backgroundImage = "url('./aboutme_header.png')"; // Change to dark mode background
  }
}
...
function darkModeOff() {
  ...
  if (headerImage) {
    headerImage.style.backgroundImage = "url('./aboutme_header.png')"; // Change to light mode background
  }
}
